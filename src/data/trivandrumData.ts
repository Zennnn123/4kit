...
function createDishesForStore(storeId: string, storeName: string, _cuisineType: string, basePriceINR: number, storeLoc: string): MenuItem[] {
  const dishTemplates = [
    ...
    { name: 'Fish Nirvana / Karimeen Pollichathu', desc: 'Pearl spot fish wrapped in banana leaf with rich spiced tomato-onion masala.', cat: 'Seafood', pDiff: 120, diet: 'non-veg', sugar: 'standard' },
    ...
    { name: 'Puttu with Kadala Curry', desc: 'Steamed cylindrical rice cake layered with grated coconut served with spicy black chickpea gravy.', cat: 'Traditional', pDiff: -120, diet: 'vegan', sugar: 'standard' },
    ...
    { name: 'Kothu Porotta (Egg & Chicken)', desc: 'Shredded crispy porotta tossed with eggs, spiced chicken salna, onions, and coriander.', cat: 'Street Food', pDiff: -20, diet: 'non-veg', sugar: 'standard' },
    { name: 'Peri-Peri Alfaham Mandi', desc: 'Smoky charcoal grilled whole chicken served over fragrant Yemeni mandi rice with garlic mayo.', cat: 'Arabian Mandi', pDiff: 80, diet: 'high-protein', sugar: 'standard' },
    { name: 'Classic Shawarma Roll (Jumbo)', desc: 'Juicy spiced sliced chicken wrapped in rumali roti with pickled veggies and toum.', cat: 'Rolls & Shawarma', pDiff: -80, diet: 'high-protein', sugar: 'standard' },
    ...
    { name: 'Nadan Kozhi Curry (Home Style)', desc: 'Country style chicken curry with roasted ground spices and thick coconut gravy.', cat: 'Curries', pDiff: 30, diet: 'non-veg', sugar: 'standard' },
    { name: 'Travancore Prawns Roast', desc: 'Fresh coastal prawns simmered with shallots, kudampuli (pot tamarind), and green chilies.', cat: 'Seafood', pDiff: 110, diet: 'non-veg', sugar: 'standard' },
